...
public class FirstPersonController : MonoBehaviour
{
    ...
    private AudioSource camera_audio; //camera audio needs its own source because footsteps may stop photo click noise.
    ...
    private void Start()
    {
        ...
        running = false;
        camera_audio = transform.FindChild("PictureCamera").GetComponent<AudioSource>();
    ...
    private void Update()
    {
        ...
        if (left_down && right_down && !flash && !running)
        {
    ...
    {
       camera_audio.clip = m_CameraSound;
        camera_audio.Play();
    }
